...
-(id)initWithFrame:(CGRect)frame
{
    ...
    if( self != nil )
    {
        ...
        //加载gif
//        NSURL *fileUrl = [[NSBundle mainBundle] URLForResource:@"1242x2208" withExtension:@"gif"];//加载GIF图片
...
////                            imageview.animationDuration=5;//每次动画时长
//                            imageview.animationRepeatCount = 1;//设置动画次数 0 表示无限

...
#import "KKLoginVC+Apple.h"
#import "KKLoginVC+Facebook.h"
#import "YXStatis.h"
#import "YXNet+YX.h"
...
@property (nonatomic, strong) KKButton *btn;

@property (nonatomic, strong) KKUsersView *tableView;
...
//    [self updateBackBtn];
    ...
    /// 账号
    self.textField1 = [[KKTextField alloc] initWithMode:YXTextFieldModeUserName];
    [self.view addSubview:self.textField1];
    
    /// 密码
    self.textField2 = [[KKTextField alloc] initWithMode:YXTextFieldModePwd];
    [self.textField2 addEyes];
    [self.view addSubview:self.textField2];
    
    NSString *text = LocalizedString(@"Sign in");
    self.btn = [KKButton button:text target:self action:@selector(btnAction)];
    [self.view addSubview:self.btn];
    
    /// 找回密码
    UIButton *forgetBtn = [KKButton smallButton:LocalizedString(@"Forget pwd") target:self action:@selector(findPwd)];
    forgetBtn.contentHorizontalAlignment = UIControlContentHorizontalAlignmentRight;
    [self.view addSubview:forgetBtn];
    
    /// 联系客服
    UIButton *serviceBtn = [KKButton smallButton:LocalizedString(@"Customer service") target:self action:@selector(serviceBtnAction)];
    ...
    self.tableView = [[KKUsersView alloc] initWithFrame:CGRectZero style:UITableViewStyleGrouped];
...
- (void)findPwd{
    ...
    KKFindVC *vc = [[KKFindVC alloc] init];
    [self push:vc];

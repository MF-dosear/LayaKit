...
@property (nonatomic, strong) KKTextField *pwdTextField;
...
- (void)viewDidLoad {
    ...
    // 验证码
    self.codeTextField = [[KKTextField alloc] initWithMode:YXTextFieldModeCode];
    ...
    // 密码
    self.pwdTextField = [[KKTextField alloc] initWithMode:YXTextFieldModePwd];
    ...
    self.btn = [KKButton button:LocalizedString(@"Change done") target:self action:@selector(btnAction)];

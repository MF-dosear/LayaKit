...
@interface KKEmailVC ()<UITextFieldDelegate>

@property (nonatomic, strong) KKTextField *emailField;

@property (nonatomic, strong) KKTextField *codeField;
...
//    label.text = @"sub-title";
    ...
    self.emailField = [[KKTextField alloc] initWithMode:YXTextFieldModeEmail];
    [self.view addSubview:self.emailField];
    
    self.codeField = [[KKTextField alloc] initWithMode:YXTextFieldModeCode];

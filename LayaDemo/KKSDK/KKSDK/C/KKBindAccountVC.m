...
#import "KKBindAccountVC+Facebook.h"
#import "KKBindAccountVC+Apple.h"

@interface KKBindAccountVC ()
@end

@implementation KKBindAccountVC
...
//    self.titleLabel.text = LocalizedString(@"Account Settings");
    ...
    KKBindBtn *fbBtn = [KKBindBtn buttonWithType:UIButtonTypeCustom];
    ...
    KKBindBtn *appleBtn = [KKBindBtn buttonWithType:UIButtonTypeCustom];
    ...
    KKBindBtn *emailBtn = [KKBindBtn buttonWithType:UIButtonTypeCustom];
...
- (void)bindEmail{
    ...
    KKEmailVC *vc = [[KKEmailVC alloc] init];
